...
var UniversityofChicago = ["Midwest",];
var UniversityofIllinois = ["Midwest",];
var UniversityofNotre Dame = ["Midwest",];
var OhioNorthernUniversity = ["Midwest",];
var WashingtonUniversityinStLouis = ["Midwest",];
var OberlinCollege = ["Midwest",];
var UniversityofMichigan = ["Midwest",];
var GrinnellCollege = ["Midwest",];
var IowaStateUniversity = ["Midwest",];
...
listOfChosenAttributes.push("HEY");
